...
class Hidester(object):
    ...
    def __init__(self):
        ...
        self.__url = 'https://hidester.com/proxydata/php/data.php?mykey=data&offset=0&limit=100&orderBy=latest_check&' \
                     ...
                     'HONDURAS,HUNGARY,INDIA,INDONESIA,ISRAEL,ITALY,JAPAN,KAZAKHSTAN,LEBANON,MACEDONIA,MALAYSIA,' \
...
if __name__ == "__main__":
    test = Hidester
    print isinstance(test, ProxyPool)
    test()
